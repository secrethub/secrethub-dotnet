...
docker-container:
	@docker build -q -t dotnet-container .
...
.PHONY: dotnet-test-docker
dotnet-test-docker: docker-container
	@docker run -v $(PWD):/secrethub-dotnet dotnet-container bash -c "make dotnet-test"
...
.PHONY: nupkg-docker
nupkg-docker: docker-container
	@echo "Making the NuGet Package using Docker..."
	@docker run -v $(PWD):/secrethub-dotnet dotnet-container bash -c "make nupkg"
